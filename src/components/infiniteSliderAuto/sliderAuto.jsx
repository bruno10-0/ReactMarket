...
export const SliderAuto = () => {
    return (
        <div>
            <div className="logos-content bg-neutral">
                <div className="logos-slide">
                    <img src="https://www.shutterstock.com/image-vector/galati-romania-april-29-2023-600nw-2295394661.jpg" />
                    <img src="https://www.shutterstock.com/image-vector/west-java-indonesia-oktober-05-260nw-2370983783.jpg" />
